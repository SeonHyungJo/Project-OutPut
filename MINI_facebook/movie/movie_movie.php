    ...
    <div id="wrapper">
        ...
        <div id="navigation">
         <ul id="menu-bar">
			...
			<li  class="active"><a href="movie_movie">영화</a>
			</li>
			<li><a href="movie_register">예매</a>
			</li>
		</ul>
        </div>
		...
		<tr><td colspan="5" rowspan="1"><i><u>사진클릭시 자세한 정보로 이동</u></i></td></tr>
		...
		<tr>
		<td>
		<img  style="width:100px; height:50px;" src="./image/1_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/2_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/3_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/4_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/5_1.jpg" alt="">
		</td>
		</tr>
		...
		<tr>
		<td>
		<img  style="width:100px; height:50px;" src="./image/6_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/7_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/8_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/9_1.jpg" alt="">
		</td>
		<td>
		<img  style="width:100px; height:50px;" src="./image/10_1.jpg" alt="">
		</td>
		</tr>
		</table>
		</div>
