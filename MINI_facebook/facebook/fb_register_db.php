...
<html><head><title>Hallo SeonHyung's FaceBook</title>
    ...
    <div id="wrapper">
		...
		<div id="content" style="text-align:cetner;">
			<form method="post" action='fb_register_action_db.php'  name="registForm" style="width: 100%; text-align:center;" >
				...
				<table style="height: 260px"  id="table" >
					...
					<tr>
						<td colspan="4" rowspan="1" style="height: 30px">
							<input style="text-align:center; font-weight: bold;" name="sex" value="남" type="radio" checked="checked">&nbsp;<span style="font-weight: bold;">남자
							</span>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td colspan="2" rowspan="1"style="height: 40px; ">전화번호<br>
				...
				<tr>
					<td>
						<div style="padding:0px; text-align:center;">
							<input  style="border:0; font-size:16px; font-weight:bold; color:white; background-color:#47C83E; width:100px; height:30px" onclick="return myFunction()" name="registFin" value="가입하기" type="submit">
						</div>
					</td>
				</tr>
			</table>
